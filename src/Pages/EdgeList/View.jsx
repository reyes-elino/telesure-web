    ...
    const demo = [
        {
            ...
            specification: 'Duis congue sit amet augue sit amet lacinia.',
        ...
        <div className="grid align-items-center">
            <div className="col-12 md:col-7 lg:col-8 xl:col-9">
                <div className='flex align-items-center gap-2'>
                    <span className="text-xl text-900 font-bold mb-5 md:mb-0">Edge List</span>
...
{/* Start - Edit Data */}
        <Dialog visible={editDialog} style={{ width: '48rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Product Details" modal blockScroll className="p-fluid" footer={editDialogFooter} onHide={hideDialog}>                  
