        ...
        <div className="grid align-items-center">
            <div className="col-12 md:col-7 lg:col-8 xl:col-9">
                <div className='flex align-items-center gap-4'>
                    <span className="text-2xl text-900 font-bold mb-5 md:mb-0">Vertex List</span>
...
{/* Start - Edit Data */}
        <Sidebar visible={editDialog} header="Details" modal blockScroll className="w-8" footer={editDialogFooter} onHide={hideDialog}>   
